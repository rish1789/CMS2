 ...
 * joining a patient to a waitlist - it leaked verbatim to the frontend via the shared
 * error-display template's message precedence. Own exception, own message.
 */
public class ForbiddenException extends RuntimeException {

    public ForbiddenException() {
        super("Only front-desk Operations staff or a ClinicAdmin can join a patient to the waitlist");
    }
}
