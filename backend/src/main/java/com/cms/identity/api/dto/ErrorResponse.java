...
/**
 * Generic error response shape (contracts/register-clinic.md). {@code failedRules} is
 * populated only for {@code INVALID_PASSWORD}; {@code field} only for
 * {@code INVALID_MOBILE_NUMBER} and {@code MISSING_REQUIRED_FIELD}. Never includes any
 * part of a submitted password.
 */
